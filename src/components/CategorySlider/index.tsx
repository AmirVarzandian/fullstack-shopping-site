...
export const CategorySlider = (prop:ISlider) =>{
    ...
    return(
        <Box sx={{width:'323px' ,height:'248px' , backgroundColor:'white' , borderRadius:'15px' , boxShadow:" 14px 10px 15px -10px rgba(8,8,8,0.7) " , my:'.5rem'}}>
<Box sx={{
    position:'relative',
        display:"flex",
  ...
  />
            <Box sx={{display:"flex" , flexDirection:"row" , alignItems:"center" , justifyContent:"center",gap:'10.5rem' , pt:".6rem" , px:".6rem", position:'absolute'}}>
            <Box sx={{width:"72px" , height:"34px" ,display:"flex" , flexDirection:"row" , justifyContent:"space-around",gap:"-1rem" , backgroundColor:"white" , alignItems:"center" , borderRadius:"100px"}}>
    <Typography fontSize={"16px"}  fontWeight={'bold'} textAlign={"center"} sx={{display:'flex',flexDirection:'row',alignItems:'center'}} ><Typography fontSize={"18px"}   fontWeight={'bold'} textAlign={"center"} color={'#FE724C'} >$</Typography>{prop.money}</Typography>
</Box>
...
<Box sx={{pt:'.5rem'}}>
    <Typography fontSize={"18px"} fontWeight={'1100px'}>{prop.name1}              </Typography>
